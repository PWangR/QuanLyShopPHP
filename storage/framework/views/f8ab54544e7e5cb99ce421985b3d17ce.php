...
<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="site_title"><i class="fa fa-shopping-bag"></i>
                <span>Electro</span></a>
        </div>
        ...
        <div class="profile clearfix">
            <div class="profile_pic">
                <img src="<?php echo e(asset('storage/' . $userAdmin->avatar)); ?>" alt="..." class="img-circle profile_img">
            </div>
            <div class="profile_info">
                <span>Xin chào,</span>
                <h2><?php echo e($userAdmin->name); ?></h2>
            </div>
        </div>
        <!-- /menu profile quick info -->
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a href="<?php echo e(route('admin.users.index')); ?>"><i class="fa fa-edit"></i> Quản lý người dùng</a>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <?php if($adminUser->role->permissions->contains('name', 'manage_manufacturers')): ?>
