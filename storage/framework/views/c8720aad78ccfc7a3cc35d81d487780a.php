  ...
  <div class="offcanvas-body d-flex flex-column p-0" style="height:calc(100vh - 56px);">
    ...
    <div class="p-3 border-top">
        ...
        <div class="d-grid gap-2 mb-2">
            <a href="<?php echo e(route('cart.index')); ?>" class="btn btn-outline-primary btn-block">Xem giỏ hàng</a>
            <a href="<?php echo e(route('checkout.placeOrder')); ?>" class="btn btn-primary btn-block">Thanh toán</a>
        </div>
    </div>

</div><?php /**PATH D:\laragon\www\QuanLyShopPHP\resources\views/clients/components/includes/mini_cart.blade.php ENDPATH**/ ?>